...
export const apiRoutes: ApiRoute[] = [
  ...
  { router: 'inside_sales', prefix: '/api/inside-sales', keyEndpoints: 'GET /agents, GET /calls, GET /leads/{prospect_id}, GET /leads, POST /collections/{source_family}/refresh, GET /leads/{prospect_id}/detail', description: 'Inside Sales collection routes — /calls, /leads, and /agents are source-backed serving surfaces; POST /collections/{source_family}/refresh enqueues explicit sync refreshes; /leads/{prospect_id} and /leads/{prospect_id}/detail remain detail surfaces' },

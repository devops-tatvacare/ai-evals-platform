...
export const apiRoutes: ApiRoute[] = [
  ...
  { router: 'inside_sales', prefix: '/api/inside-sales', keyEndpoints: 'GET /agents, GET /calls, GET /leads/{prospect_id}, GET /leads, GET /leads/{prospect_id}/detail', description: 'Inside Sales collection routes — /calls, /leads, and /agents are serving surfaces; /leads/{prospect_id} and /leads/{prospect_id}/detail are detail and refresh surfaces' },

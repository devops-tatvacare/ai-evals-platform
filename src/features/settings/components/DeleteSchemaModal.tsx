    ...
    >
      <div className="space-y-4">
        <p className="text-[14px] text-[var(--text-primary)]">
          Are you sure you want to delete <strong>"{schema.name}"</strong>?
        </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-[13px] text-[var(--color-warning)]">
                <p className="font-medium">
                  This schema is used by {dependencies.count} evaluation{dependencies.count !== 1 ? 's' : ''}
                </p>
                ...
                <p className="mt-2 text-[12px]">
                  These evaluations will retain a copy of the schema.
                </p>
              </div>
            </div>
          </div>

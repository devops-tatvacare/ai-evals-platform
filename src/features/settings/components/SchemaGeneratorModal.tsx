...
const PROMPT_TYPE_PLACEHOLDERS: Record<PromptType, string> = {
  ...
  evaluation: 'e.g., "Add per-segment accuracy scores, error categories like dosage/medication/speaker"',
  extraction: 'e.g., "Extract patient demographics, medications with dosages, diagnoses, and follow-up dates"',
};
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-[13px] text-[var(--text-secondary)]">
          Describe the output structure you need, and AI will generate a JSON Schema for structured responses.
        </p>
